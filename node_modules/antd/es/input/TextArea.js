...
var TextArea = function (_React$Component) {
    ...
    _createClass(TextArea, [{
        ...
        value: function getTextAreaClassName() {
            ...
            return classNames(prefixCls, _defineProperty({}, prefixCls + '-disabled', disabled));
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            return React.createElement('textarea', _extends({}, otherProps, { className: classNames(this.getTextAreaClassName(), props.className), style: style, onKeyDown: this.handleKeyDown, onChange: this.handleTextareaChange, ref: this.saveTextAreaRef }));
        }
    }]);
